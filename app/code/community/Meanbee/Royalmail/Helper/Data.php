...
class Meanbee_Royalmail_Helper_Data extends Mage_Core_Helper_Abstract {
    ...
    protected static $_internationalMethodAvailability = array(
        ...
        'AU' => array(self::INTERNATIONAL_SIGNED),
        ...
        'BR' => array(self::INTERNATIONAL_SIGNED),
        ...
        'CA' => array(self::INTERNATIONAL_TRACKED_AND_SIGNED),
        ...
        'CH' => array(self::INTERNATIONAL_TRACKED_AND_SIGNED),
        ...
        'VI' => array(self::INTERNATIONAL_SIGNED),
