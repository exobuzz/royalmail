...
class Meanbee_Royalmail_Model_Shipping_Carrier_Royalmail_Airmail
    ...
    protected function getRates() {
        ...
        // we want to allow "standard" airmail for Brazil, Canada, Australia and Israel. If the country
        // isn't one of these we are not calling from an airsure / signed for class (using airmail
        // class directly) and we are in the frontend then return nothing.
